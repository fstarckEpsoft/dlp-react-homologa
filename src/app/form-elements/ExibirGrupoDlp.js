...
export class BasicElements extends Component {
  ...
  handleSubmitPutComputador = (event) => {
    ...
    const computador = {
      ...
      computer_name: "^^" + this.state.grupoDlp,
      maquina: "todas",
    ...
    DlpController.getPorGrupo().then((response) => {
      ...
      /*for(let i = 0; i < this.state.todosDadosArrayDlp.length; i++) {
          ...
          for(let j = 0; j < this.state.todosDadosArrayDlp.length; j++) {
            ...
            console.log(this.state.todosDadosArrayDlp[i]);
  ...
  findByJsonDefault = async (grupo) => {
    let dadosGrupoSelecionado = [];

    DlpController.getByGrupoDlpSelecionado(grupo).then((response) => {
      console.log("GRUPO SELECIOANDO: " + grupo);
      console.log(response.data);
      dadosGrupoSelecionado = response.data;

      /* ARMAZENA OS DADOS INVOD DA RESPOSATA NOS CAMPOS ESPECIFICADOS */
      this.converterJSON(JSON.parse(response.data[0].json));

      console.log("JSON !!!: ");
      console.log(JSON.parse(response.data[0].json));
    });

    /*console.log('DADOS: ');
    console.log(dadosGrupoSelecionado);

    console.log('JSON RESPOSTA (TXT): ');
    console.log(this.state.dadosFiltrados[0].json);

    console.log('JSON RESPOSTA (JSON): ');
    console.log(JSON.parse(this.state.dadosFiltrados[0].json));

    this.state.arrayDlp = JSON.parse(this.state.dadosFiltrados[0].json)

    console.log(this.state.arrayDlp[0]);

    this.state.grupo_dlp = this.state.arrayDlp[0].grupoDlp;

    this.state.grupoAntigo = this.state.arrayDlp[0].grupoDlp; //ARMAZENA O GRUPO ANTIGO

    console.log('GRUPO DLP: ');
    console.log(this.state.grupo_dlp);*/
    ...
    // DADOS BASE x64 - J1
    /*this.state.titulosADesprezar = this.state.arrayDlp[0].titulosADesprezar;
    this.state.classesDebugar = this.state.arrayDlp[0].classesDebugar;
    this.state.jansFilhasMonitorar = this.state.arrayDlp[0].jansFilhasMonitorar;
    this.state.ipCloud = this.state.arrayDlp[0].ipCloud;
    this.state.portaCloud = this.state.arrayDlp[0].portaCloud;
    this.state.portaDlp = this.state.arrayDlp[0].portaDlp;
    this.state.conectivosExcluir = this.state.arrayDlp[0].conectivosExcluir;
    this.state.driveServer = this.state.arrayDlp[0].driveServer;
    this.state.cliAtual = this.state.arrayDlp[0].cliAtual;
    this.state.grupoDlp = this.state.arrayDlp[0].grupoDlp;
    this.state.percentualCompacArquivos = this.state.arrayDlp[0].percentualCompacArquivos;
    this.state.origensAlarme = this.state.arrayDlp[0].origensAlarme;
    this.state.statusAlarme = this.state.arrayDlp[0].statusAlarme;
    this.state.tiposAlarme = this.state.arrayDlp[0].tiposAlarme;

    this.state.extensoesSensiveis = "txt,xlsx,docx,ppt,pptx,xls,doc,pdf,html,xml";*/
    ...
    // DADOS BASE X64 - J2
    /*this.state.anonimizaDadosRelatorios = this.state.arrayDlp[0].anonimizaDadosRelatorios;
    ...
    this.state.desativaPrintScreen = this.state.arrayDlp[0].desativaPrintScreen;
    this.state.filmar_sempre = this.state.arrayDlp[0].filmar_sempre;
    this.state.monitoraDispExternos = this.state.arrayDlp[0].monitoraDispExternos;
    this.state.quandoPegarDadosSensiveis = this.state.arrayDlp[0].quandoPegarDadosSensiveis;
    ...
    this.state.tempoDragAndDrop = this.state.arrayDlp[0].tempoDragAndDrop;
    this.state.impressaoSpooler = this.state.arrayDlp[0].impressaoSpooler;*/
    ...
    /*if(String(this.state.pastasSensiveis).toLowerCase() === undefined || String(this.state.pastasSensiveis).toLowerCase() === null) {
      ...
      try {
        ...
        this.state.pastasSensiveis = memoriaPastasSensiveis;
    ...
    /*DlpController.getByJsonDefault()
      .then(response => {
        ...
        console.log('JSON DEFAULT ENVIO EM MASSA: ');
  ...
  converterJSON = async (obj) => {
    ...
    console.log("OBJETO RESPOSTA: ");
    console.log(obj);

    this.state.grupo_dlp = obj[0].grupoDlp;

    this.state.grupoAntigo = obj[0].grupoDlp; //ARMAZENA O GRUPO ANTIGO
    ...
    // DADOS BASE x64 - J1
    this.state.titulosADesprezar = obj[0].titulosADesprezar;
    this.state.classesDebugar = obj[0].classesDebugar;
    this.state.jansFilhasMonitorar = obj[0].jansFilhasMonitorar;
    this.state.ipCloud = obj[0].ipCloud;
    this.state.portaCloud = obj[0].portaCloud;
    this.state.portaDlp = obj[0].portaDlp;
    this.state.conectivosExcluir = obj[0].conectivosExcluir;
    this.state.driveServer = obj[0].driveServer;
    this.state.cliAtual = obj[0].cliAtual;
    this.state.grupoDlp = obj[0].grupoDlp;
    this.state.percentualCompacArquivos = obj[0].percentualCompacArquivos;
    this.state.origensAlarme = obj[0].origensAlarme;
    this.state.statusAlarme = obj[0].statusAlarme;
    this.state.tiposAlarme = obj[0].tiposAlarme;

    this.state.extensoesSensiveis =
      "txt,xlsx,docx,ppt,pptx,xls,doc,pdf,html,xml";
    //this.setState({ palavrasSensiveis: this.state.arrayDlp[0].palavrasSensiveis });

    //this.setState({ codCliente: this.state.arrayDlp[0].codCliente });
    this.state.codCliente = obj[0].codCliente;
    //this.setState({ codigoMaquinaPorUsuario: this.state.arrayDlp[0].codigoMaquinaPorUsuario });
    this.state.codigoMaquinaPorUsuario = obj[0].codigoMaquinaPorUsuario;

    // DADOS BASE X64 - J2
    this.state.anonimizaDadosRelatorios = obj[0].anonimizaDadosRelatorios;
    this.setState({ ativaEmailAlmGraves: "1" });
    this.setState({ ativaEmailAlmGravissimos: "1" });
    this.setState({ ativaEmailAlmSerios: "1" });
    this.setState({ ativaSmsAlmGraves: "1" });
    this.setState({ ativaSmsAlmGravissimos: "1" });
    this.setState({ ativaSmsAlmSerios: "1" });
    this.state.desativaPrintScreen = obj[0].desativaPrintScreen;
    this.state.filmar_sempre = obj[0].filmar_sempre;
    this.state.monitoraDispExternos = obj[0].monitoraDispExternos;
    this.state.quandoPegarDadosSensiveis = obj[0].quandoPegarDadosSensiveis;
    this.state.driversPermitidos = obj[0].driversPermitidos;
    this.state.impedirDragDrop = obj[0].impedirDragDrop;
    this.state.semDragDrop = obj[0].semDragDrop;
    this.setState({ imgBlockPrtSc: "/j/users/dlp/TELA_BLOQUEIO_PRINT.png" });
    this.setState({ qtMinQualifsTab: "3" });
    this.setState({ qtMinQualifsDoc: "5" });
    this.setState({ maxQtFalsosNomes: "3" });
    ...
    this.setState({ tempoDragAndDrop: obj[0].tempoDragAndDrop });
    this.setState({ impressaoSpooler: obj[0].impressaoSpooler });
    this.setState({ naoTestarDragDrop: obj[0].naoTestarDragDrop });

    this.setState({ naoTestarCopiaArquivo: obj[0].naoTestarCopiaArquivo });

    this.setState({
      classificacaoAlarmeDragDrop: obj[0].classificacaoAlarmeDragDrop,
    });
    ...
    if (
      ...
      try {
        ...
        console.log("Dado JSON: ");
        console.log(obj[0].pastasSensiveis);

        memoriaPastasSensiveis = obj[0].pastasSensiveis.split("//").join("\\");
        memoriaPastasSensiveis = obj[0].pastasSensiveis.replace(/\\\\/g, "\\");
  ...
  criptografarJSON = async (obj) => {
    ...
    */
    ...
    //DlpController.putGrupoDLP( this.state.grupoAntigo, objetoEnvio).then((response) => console.log(response));

    DlpController.postJson(obj).then((response) => console.log( response ));

    setTimeout(function () { alert("Dado(s) Alterados com sucesso!") },  2000);
    ...
    setTimeout(function () {
      ...
      window.location.href = `${DlpController.ambienteRedirecionamentoReact()}/flashsafe/conf/form-Elements/exibir-grupo-dlp/?ss=${tokenAcesso}`;
    }, 300);
    ...
    /*for(let i = 0; i < this.state.todosDadosArrayDlp.length; i++) {
      for(let j = 0; j < this.state.selecao.length; j++) {
        ...
        if(this.state.todosDadosArrayDlp[i].maquina === this.state.selecao[j] && !trava) {
          ...
          //setTimeout(function() {
            //window.location.href = `http://54.207.237.19:3o01/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `https://app.flashsafe.com:3o03/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `https://app.flashsafe.com:3o01/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `https://app.flashsafe.com:3o00/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `https://app.flashsafe.com:3o07/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `http://m2g.com.br:3o00/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `https://app.flashsafe.com:3o06/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `https://app.flashsafe.com:3o09/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `http://54.207.116.254:3o00/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
            //window.location.href = `http://localhost:3o00/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
  ...
  deletarItem = async () => {
    ...
    const objeto = {
      maquina: this.state.memoriaGrupoSelecionado.maquina,
      hash_maquina: null,
      computer_name: null,
      grupo_dlp: this.state.memoriaGrupoSelecionado.grupo_dlp,
      json: this.state.memoriaGrupoSelecionado.json,
      cksum: this.state.memoriaGrupoSelecionado.cksum,
      data_atualizacao: this.state.memoriaGrupoSelecionado.data_atualizacao,
    };

    console.log("DADOS PARA O DELETE: ");
    console.log(JSON.stringify(objeto));

    DlpController.deleteGrupoDLP(objeto)
      .then((respostaDeletada) => console.log(respostaDeletada))
    ...
    /*DlpController.getByGrupoDlpSelecionado(this.state.grupoAntigo)
      .then(response => {

        DlpController.deleteGrupoDLP(response.data[0])
          .then(respostaDeletada => console.log(respostaDeletada));
    ...
    /*this.findByJsonDefault(this.state.grupoAntigo);
    ...
    const computador = {
      base64_j1: {
        ...
        monitoraDispExternos:  this.state.monitoraDispExternos, //1
        quandoPegarDadosSensiveis: this.state.quandoPegarDadosSensiveis,
    ...
    this.ajustaJSONparaDelecao(computador);*/
  };
  ...
  ajustaJSONparaDelecao = async (obj) => {
    ...
    //DlpController.deleteGrupoDLP(objetoEnvio)
    //  .then(response => console.log(response));
    ...
    //window.location.href = `https://app.flashsafe.com:3o09/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
    //window.location.href = `http://54.207.116.254:3o00/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
    //window.location.href = `http://localhost:30o0/flashsafe/conf/form-Elements/basic-elements/?ss=${tokenAcesso}`;
  ...
  handleOnSelect = (row, isSelect) => {
    ...
    this.findByJsonDefault(row.grupo_dlp);

    this.state.memoriaGrupoSelecionado = row;
  ...
  */}
                  ...
                  */}
                    ...
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <div className="col-sm-12">
                        <Form.Control type="text" value="Não testar COPIA ARQUIVO" disabled />
                        </div>
                      </Form.Group>
                    </div>
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <div className="col-sm-12">
                          <select className="opcoes-select" name="estado" value={this.state.naoTestarCopiaArquivo} onChange={this.handleChangenaoTestarCopiaArquivo} >
                    ...
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <div className="col-sm-12">
                        <Form.Control type="text" value="Não testar DRAG AND DROP" disabled />
                        </div>
                      </Form.Group>
                    </div>
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <div className="col-sm-12">
                          <select className="opcoes-select" name="estado" value={this.state.naoTestarDragDrop} onChange={this.handleChangenaonaoTestarDragDrop} >
                            <option value="">DESABILITADO</option>
                            <option value="0">0</option>            
                          </select>
                        </div>
                    ...
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <div className="col-sm-12">
                        <Form.Control type="text" value="Classifica Alarme Drag and Drop" disabled />
                        </div>
                      </Form.Group>
                    </div>
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <div className="col-sm-12">
                          <select className="opcoes-select" name="estado" value={this.state.classificacaoAlarmeDragDrop} onChange={this.handleChangeclassificacaoAlarmeDragDrop} >
...
{/*                   <div className="botoes-acoes col-md-12">
                    <div className="botao-salvar-alteracoes">
                      <button type="submit" onClick={() => this.enviarDadosAoServidor()} > Salvar Alterações </button>
                    </div>
                    <a href="#adicionarAncoramento" className="botao-salvar-alteracoes" onClick={() => this.zerarVariaviesJ3()} >
                      <button type="button" data-toggle="modal" data-target="#adicionarItemModal" >Nova Configuração</button>
                    </a>
                    <a className="botao-salvar-alteracoes">
                      <button type="button" onClick={() => this.deletarItem()}>Deletar Grupo</button>
                    </a>
                  </div> */}
                </form>
              </div>
...
{/*                     <div class="modal-footer col-md-12 botao-enviar">
                      ...
                      <button type="submit" data-dismiss="modal">Salvar</button>
                    </div> */}
...
{/*                     <div class="modal-footer col-md-12 botao-enviar">
                      ...
                      <button type="submit" data-dismiss="modal" onClick={this.handleSubmitPostL3} >Salvar</button>
                    </div> */}
                  </form>
                </div>
              </div>
